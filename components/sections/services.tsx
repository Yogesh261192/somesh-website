...
const services = [
  {
    ...
    url: "/services/back-pain-treatment",
  ...
  },
  {
    ...
    url: "/services/post-surgery-rehabilitation",
  ...
  },
  {
    ...
    url: "/services/elderly-mobility-physiotherapy",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service, index) => (
            <Card 
              key={service.title} 
              className={`group relative overflow-hidden border-border/50 bg-gradient-to-br ${service.color} transition-all duration-300 hover:border-primary/30 hover:shadow-lg ${service.borderColor}`}
            >
              <CardHeader>
