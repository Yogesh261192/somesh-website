...
export const metadata: Metadata = {
  title: "Home Physiotherapy in Raj Nagar & Extension | Expert Care",
  description: "Specialized home physiotherapy serving Raj Nagar Extension, RDC, and Kavi Nagar. Book reliable home visits for pain relief and post-surgery rehab.",
  keywords: "physiotherapy in raj nagar extension, home physio raj nagar, physiotherapist RDC, knee rehab raj nagar",
}

export default function RajNagarLocationPage() {
  const subAreas = [
    "Raj Nagar Extension",
    "Raj Nagar District Centre (RDC)",
    "Kavi Nagar",
    "Sanjay Nagar",
    "Shastri Nagar",
    "Govindpuram"
      ...
      <section className="bg-gradient-to-r from-primary/10 to-primary/5 py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-foreground mb-6">
            Expert Physiotherapy at Home in Raj Nagar
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10">
            High-quality home physiotherapy care for residents of Raj Nagar Extension and surrounding localities. We bring clinical-grade equipment to your home.
          </p>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Areas We Serve in Raj Nagar</h2>
